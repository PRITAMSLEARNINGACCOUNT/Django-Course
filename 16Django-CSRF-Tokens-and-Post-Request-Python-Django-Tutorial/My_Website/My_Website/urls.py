...
from . import Final_Website
urlpatterns = [
    path('admin/', admin.site.urls),
    path('', Final_Website.Webpage_Show,
         name="This function shows the main webpage"),
    path("Main_Function", Final_Website.main,
         name="This function decides what to do or not to do"),
    path("Contact_Us", Final_Website.Contact_us,
         name="This pipeline shows the webpage of contact us"),
    path("About_Us", Final_Website.About_Us,
